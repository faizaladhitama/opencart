<?php
// Heading
$_['heading_title'] = 'Gagal Bayar!';    // Original :  'Failed Payment!';

// Text
$_['text_basket']   = 'Keranjang Belanja';    // Original :  'Shopping Cart';
$_['text_checkout'] = 'Checkout';    // Original :  'Checkout';
$_['text_failure']  = 'Gagal Bayar';    // Original :  'Failed Payment';
